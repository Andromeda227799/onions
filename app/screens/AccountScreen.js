    ...
    <SafeScreen>
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <AppButton2 style={{backgroundColor:colors.primary,width:"65%"}} title="View Requested Items" onPress={()=>{}}/>
          <AppButton2 style={{borderColor:colors.black,borderWidth:1,width:"45%"}} fontColor={colors.black} title="Logout" onPress={()=>{navigation.navigate("Login")}}/>
      </View>
      </View>
